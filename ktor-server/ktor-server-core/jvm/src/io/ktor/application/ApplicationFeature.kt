 ...
 */
class MissingApplicationFeatureException(val key: AttributeKey<*>) : IllegalStateException(), CopyableThrowable<MissingApplicationFeatureException> {
    override val message: String get() = "Application feature ${key.name} is not installed"

    override fun createCopy(): MissingApplicationFeatureException? = MissingApplicationFeatureException(key)
}
